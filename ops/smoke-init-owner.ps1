...
function Invoke-Migrations {
    ...
    Invoke-Compose -Arguments @("run", "--rm", "backend", "aisaas-backend", "migrate") | Out-Host
}
...
$postgresDb = Get-EnvValue -Values $envValues -Key "POSTGRES_DB" -Default "aisaas"
