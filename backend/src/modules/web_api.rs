        ...
        .map(|model| {
            ...
            Ok(json!({
                ...
                "billing": {
                    ...
                    "input1kPriceMinor": model.input_1k_price_minor,
                    "output_1k_price_minor": model.output_1k_price_minor,
                    "output1kPriceMinor": model.output_1k_price_minor,
                    "request_price_minor": model.request_price_minor,
                    "requestPriceMinor": model.request_price_minor,
                    "image_price_minor": model.image_price_minor,
                    "imagePriceMinor": model.image_price_minor,
                    "second_price_minor": model.second_price_minor,
                    "secondPriceMinor": model.second_price_minor,
                    "minute_price_minor": model.minute_price_minor,
                    "minutePriceMinor": model.minute_price_minor,
                },
