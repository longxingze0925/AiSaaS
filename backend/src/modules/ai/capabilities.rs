...
pub struct ModelCapabilities {
    ...
    pub max_image_asset_size_mb: Option<i64>,
    pub max_video_asset_size_mb: Option<i64>,
    pub max_audio_asset_size_mb: Option<i64>,
    pub min_reference_video_seconds: Option<i64>,
    pub max_reference_video_seconds: Option<i64>,
    pub total_reference_video_seconds: Option<i64>,
    pub min_reference_audio_seconds: Option<i64>,
    pub max_reference_audio_seconds: Option<i64>,
    pub total_reference_audio_seconds: Option<i64>,
}
...
impl ModelCapabilities {
    pub fn from_config(config: &Value) -> Result<Self, AppError> {
        ...
        Ok(Self {
            ...
            max_image_asset_size_mb: first_positive_int(
                source,
                &["maxImageAssetSizeMb", "max_image_asset_size_mb"],
            )?,
            max_video_asset_size_mb: first_positive_int(
                source,
                &["maxVideoAssetSizeMb", "max_video_asset_size_mb"],
            )?,
            max_audio_asset_size_mb: first_positive_int(
                source,
                &["maxAudioAssetSizeMb", "max_audio_asset_size_mb"],
            )?,
            min_reference_video_seconds: first_positive_int(
                source,
                &["minReferenceVideoSeconds", "min_reference_video_seconds"],
            )?,
            max_reference_video_seconds: first_positive_int(
                source,
                &["maxReferenceVideoSeconds", "max_reference_video_seconds"],
            )?,
            total_reference_video_seconds: first_positive_int(
                source,
                &[
            ...
            min_reference_audio_seconds: first_positive_int(
                source,
                &["minReferenceAudioSeconds", "min_reference_audio_seconds"],
            )?,
            max_reference_audio_seconds: first_positive_int(
                source,
                &["maxReferenceAudioSeconds", "max_reference_audio_seconds"],
            )?,
            total_reference_audio_seconds: first_positive_int(
                source,
                &[
    ...
    pub fn to_public_json(&self) -> Value {
        json!({
            ...
            "maxImageAssetSizeMb": self.max_image_asset_size_mb,
            "maxVideoAssetSizeMb": self.max_video_asset_size_mb,
            "maxAudioAssetSizeMb": self.max_audio_asset_size_mb,
            "minReferenceVideoSeconds": self.min_reference_video_seconds,
            "maxReferenceVideoSeconds": self.max_reference_video_seconds,
            "totalReferenceVideoSeconds": self.total_reference_video_seconds,
            "minReferenceAudioSeconds": self.min_reference_audio_seconds,
            "maxReferenceAudioSeconds": self.max_reference_audio_seconds,
            "totalReferenceAudioSeconds": self.total_reference_audio_seconds,
        })
    }
}
...
mod tests {
    ...
    fn public_capabilities_are_stable_shape() {
        ...
        assert_eq!(public["maxImageAssetSizeMb"], json!(30));
        assert_eq!(public["maxVideoAssetSizeMb"], json!(50));
        assert_eq!(public["maxAudioAssetSizeMb"], json!(15));
        assert_eq!(public["minReferenceVideoSeconds"], json!(2));
        assert_eq!(public["maxReferenceVideoSeconds"], json!(15));
        assert_eq!(public["totalReferenceVideoSeconds"], json!(15));
        assert_eq!(public["minReferenceAudioSeconds"], json!(2));
        assert_eq!(public["maxReferenceAudioSeconds"], json!(15));
        assert_eq!(public["totalReferenceAudioSeconds"], json!(15));
