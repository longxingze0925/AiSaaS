    ...
    >
      <Routes>
        ...
        <Route element={<ProtectedRoutes />}>
          ...
          <Route path="api-access" element={<ApplicationsPage />} />
          <Route path="apps" element={<Navigate to="/api-access" replace />} />
          ...
          <Route path="devices" element={<Navigate to="/customers" replace />} />
          <Route path="releases" element={<Navigate to="/logs/ai-assets" replace />} />
          <Route path="scripts" element={<Navigate to="/logs/ai-assets" replace />} />
