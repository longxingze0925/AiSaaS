...
const messageText: Record<string, string> = {
  application_create_failed: "接入配置创建失败",
  application_created: "接入配置已创建",
  application_keys_rotated: "接入密钥已轮换",
  application_required: "请选择接入配置",
  application_rotate_keys_failed: "接入密钥轮换失败",
  application_update_failed: "接入配置更新失败",
  application_updated: "接入配置已更新",
  applications_load_failed: "接入配置列表加载失败",
  account_disabled: "账号已被禁用",
  activation_rate_limited: "激活请求过于频繁，请稍后再试",
  already_revoked: "已被吊销",
  app_disabled: "接入配置已被禁用",
  app_not_found: "接入配置不存在",
  ...
  customer_create_failed: "用户创建失败",
  customer_created: "用户已创建",
  customer_disable_failed: "用户禁用失败",
  customer_disabled: "用户已禁用，已撤销 {count} 个会话",
  customer_password_reset_email_queued: "密码重置邮件已加入发送队列",
  customer_password_reset_failed: "密码重置失败",
  customer_update_failed: "用户更新失败",
  customer_updated: "用户已更新",
  customers_load_failed: "用户列表加载失败",
...
const permissionText: Record<string, string> = {
  ...
  "app:read": "查看接入配置",
  "app:read_key": "查看接入公钥",
  "app:rotate_key": "轮换接入密钥",
  "app:update": "更新接入配置",
  "audit:export": "导出审计日志",
  "audit:read": "查看审计日志",
  "customer:create": "创建用户",
  "customer:delete": "删除客户",
  "customer:disable": "禁用用户",
  "customer:enable": "启用客户",
  "customer:read": "查看用户",
  "customer:reset_password": "重置用户密码",
  "customer:update": "更新用户",
...
const outboxEventTypeText: Record<string, string> = {
  ...
  "email.customer_email_verify": "用户邮箱验证邮件",
  "email.customer_password_reset": "用户密码重置邮件",
